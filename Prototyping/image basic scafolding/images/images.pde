...
void setup() {
  ...
  picmotorcycle = loadImage("../../../Images/portrait/Motorcycle.jpg");
  picmotorcycleWidthChanged = picmotorcycleWidth = 894;
  picmotorcycleHeightChanged = picmotorcycleHeight = 894;
  //
  //Image Compression
  float biggerSide = ( picmotorcycleWidth > picmotorcycleHeight ) ? picmotorcycleWidth : picmotorcycleHeight ;
  float smallerSide = ( picmotorcycleHeight < picmotorcycleWidth ) ? picmotorcycleHeight : picmotorcycleWidth ;
